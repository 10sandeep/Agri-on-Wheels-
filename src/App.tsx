...
import { Tractor, Bone as Drone, Leaf, Users, BookOpen, Headset as VrHeadset, BarChart3, MapPin, CheckCircle2, Home, FileText } from 'lucide-react';
  ...
  const renderHome = () => (
    <>
      ...
      <div className="w-full bg-white py-8">
        <img 
          src="https://raw.githubusercontent.com/stackblitz/stackblitz-images/main/dassault-banner.jpg" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Hands-on demonstration of agricultural drones for spraying and mapping"
              },
              {
      ...
      <section className="py-16 bg-green-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
            {[
              { icon: <Users className="w-8 h-8" />, value: "500+", label: "Farmers Trained" },
              { icon: <MapPin className="w-8 h-8" />, value: "6", label: "Month Program" },
              { icon: <BarChart3 className="w-8 h-8" />, value: "100%", label: "Hands-on Training" },
              { icon: <BookOpen className="w-8 h-8" />, value: "5+", label: "Training Modules" }
            ].map((metric, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow">
                <div className="text-green-600 flex justify-center mb-4">{metric.icon}</div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h3 className="text-lg font-semibold text-gray-800 mb-2">DSF Project ID</h3>
                <p className="text-gray-600">IN-2024-2-08</p>
              </div>

              <div>
                <h3 className="text-lg font-semibold text-gray-800 mb-2">DSF Agreement ID</h3>
                <p className="text-gray-600">2025-289</p>
              </div>
            </div>

            <div>
              <h3 className="text-lg font-semibold text-gray-800 mb-2">Funding Released in FY 24-25</h3>
          ...
          <div className="flex justify-center space-x-8 py-4">
            <button
              ...
              className={`flex items-center space-x-2 px-4 py-2 rounded-md ${
                currentPage === 'home' ? 'bg-green-50 text-green-600' : 'text-gray-600 hover:text-green-600'
              }`}
            >
            ...
            <button
              ...
              className={`flex items-center space-x-2 px-4 py-2 rounded-md ${
                currentPage === 'details' ? 'bg-green-50 text-green-600' : 'text-gray-600 hover:text-green-600'
              }`}
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                This project is supported by La Fondation Dassault Systemes. A comprehensive initiative 
                to bring modern agricultural practices and technology to farmers through immersive 
                learning experiences and hands-on training.
              </p>
            </div>
            <div>
